...
enum PlayerInvestigationAllInfoNotify_CmdId {
  ...
  PlayerInvestigationAllInfoNotify_CmdId_CMD_ID = 1901,
...
enum TakeInvestigationRewardReq_CmdId {
  ...
  TakeInvestigationRewardReq_CmdId_CMD_ID = 1902,
...
enum TakeInvestigationRewardRsp_CmdId {
  ...
  TakeInvestigationRewardRsp_CmdId_CMD_ID = 1903,
...
enum TakeInvestigationTargetRewardReq_CmdId {
  ...
  TakeInvestigationTargetRewardReq_CmdId_CMD_ID = 1904,
...
enum TakeInvestigationTargetRewardRsp_CmdId {
  ...
  TakeInvestigationTargetRewardRsp_CmdId_CMD_ID = 1905,
...
enum GetInvestigationMonsterReq_CmdId {
  ...
  GetInvestigationMonsterReq_CmdId_CMD_ID = 1906,
...
enum GetInvestigationMonsterRsp_CmdId {
  ...
  GetInvestigationMonsterRsp_CmdId_CMD_ID = 1907,
...
enum PlayerInvestigationNotify_CmdId {
  ...
  PlayerInvestigationNotify_CmdId_CMD_ID = 1908,
...
enum PlayerInvestigationTargetNotify_CmdId {
  ...
  PlayerInvestigationTargetNotify_CmdId_CMD_ID = 1909,
...
class InvestigationTarget : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.InvestigationTarget) */ {
 public:
  ...
  static const int kInvestigationIdFieldNumber = 2;
...
class PlayerInvestigationAllInfoNotify : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.PlayerInvestigationAllInfoNotify) */ {
 public:
  ...
  static const int kInvestigationTargetListFieldNumber = 2;
...
class InvestigationMonster : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.InvestigationMonster) */ {
 public:
  ...
  static const int kRefreshIntervalFieldNumber = 6;
  ...
  static const int kLockStateFieldNumber = 8;
  ...
  static const int kMaxBossChestNumFieldNumber = 9;
  ...
  static const int kBossChestNumFieldNumber = 10;
  ...
  static const int kWorldResinFieldNumber = 11;
...
// uint32 world_resin = 11;
inline void InvestigationMonster::clear_world_resin() {
  world_resin_ = 0u;
}
inline ::google::protobuf::uint32 InvestigationMonster::world_resin() const {
  // @@protoc_insertion_point(field_get:proto.InvestigationMonster.world_resin)
  return world_resin_;
}
inline void InvestigationMonster::set_world_resin(::google::protobuf::uint32 value) {
